    ...
    def _check_work_date(self):
        for record in self:
            if record.work_date:
                ...
                is_sunday = record.work_date.weekday() == 6  # 6 represents Sunday
                ...
                if not (is_sunday or is_public_holiday):
                    raise UserError("Compensatory leave is only applicable for Sundays or public holidays.")
