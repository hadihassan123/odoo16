...
#
#     # sale_summary_lines = fields.One2many('purchase.order.product.summary', 'sale_order_id', string='Product Summary')
#     product_summary_lines = fields.One2many('purchase.order.product.summary', 'sale_order_id', string='Product Summary')
#
#
#     def copy_product_summary_lines(self):
#         for order in self:
...
#     _description = 'Purchase Order Product Summary'
#
#     sale_order_id = fields.Many2one('sale.order', string='Purchase Order', ondelete='cascade')
#     purchase_order_id = fields.Many2one('purchase.order', string='Purchase Order', required=True, ondelete='cascade')
#     product_id = fields.Many2one('product.product', string='Product', required=True)
#     name = fields.Char(related='product_id.name', string='Product Name', readonly=True)
#     unit_price = fields.Float(related='product_id.standard_price', string='Unit Price', readonly=True)
...
#     date = fields.Date(string='Date', default=fields.Date.context_today, readonly=True)
#
# # class SaleOrderProductSummary(models.Model):
# #     _name= 'sale.order.product.summary'
# #     _inherit = 'purchase.order.product.summary'
# #     _description = 'Sale Order Product Summary'
# #
...
# #     revised_unit_price = fields.Float(string='Revised Unit Price', compute='_compute_revised_unit_price', store=True)
# #     user_id = fields.Many2one('res.users', string='User', default=lambda self: self.env.user, readonly=True)
# #     date = fields.Date(string='Date', default=fields.Date.context_today, readonly=True)
# #
...
# #         for summary in self:
# #             sale_order_line = self.env['sale.order.line'].search([
# #                 ('order_id', '=', summary.sale_order_id.id),
# #                 ('product_id', '=', summary.product_id.id)
# #             ], limit=1)
# #             if sale_order_line:
# #                 summary.revised_unit_price = sale_order_line.price_unit
#
#
# class PurchaseOrderLine(models.Model):
#     _inherit = 'purchase.order.line'
